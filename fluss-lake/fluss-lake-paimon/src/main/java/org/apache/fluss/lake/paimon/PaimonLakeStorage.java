...
import org.apache.fluss.lake.paimon.lookup.PaimonScanLakeTableLookuper;
...
public class PaimonLakeStorage implements LakeStorage {
    ...
    public LakeTableLookuper createLakeTableLookuper(TablePath tablePath, LookuperContext context) {
        if (context.lookupMode() == LookupMode.SCAN) {
            return new PaimonScanLakeTableLookuper(paimonConfig, tablePath, context.tableConfig());
        }
